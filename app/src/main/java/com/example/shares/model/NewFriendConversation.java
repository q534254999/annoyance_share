...
import com.example.shares.Config;
import com.example.shares.MyApplication;
import com.example.shares.R;
...
public class NewFriendConversation extends Conversation{
    ...
    public int getUnReadCount() {
        return NewFriendManager.getInstance(MyApplication.getContext()).getNewInvitationCount();
    }

    @Override
    public void readAllMessages() {
        //批量更新未读未认证的消息为已读状态
        NewFriendManager.getInstance(MyApplication.getContext()).updateBatchStatus();
    }
